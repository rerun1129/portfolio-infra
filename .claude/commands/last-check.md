...
1. 시스템 수준 메모리 디렉토리 탐색 (glob으로 인코딩 이름 매칭):
   - 회사 PC / 집 PC 공통: `~/.claude/projects/*portfolio-infra*/memory/`
   - Windows 환경에서는 `%USERPROFILE%\.claude\projects\*portfolio-infra*\memory\`
